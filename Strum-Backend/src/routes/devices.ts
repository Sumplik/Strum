...
import { deleteDevice, listDeviceLogs, listDevices, requireDevice, serializeDevice } from "../services/devices";
import { summarizeBranch, summarizeDevices } from "../services/summary";
...
export const deviceRoutes = new Elysia({ prefix: "/branches/:branchId" })
  .get(
    ...
    { query: t.Object({ status: statusFilterSchema, search: t.Optional(t.String({ maxLength: 100 })) }) },
  )
